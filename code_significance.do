...
***Symmetric
foreach loc in `countries'{
qui var d_gdp d_l_oil_price_opec_real d_l_cpi d_interest d_unemployment d_l_ipi_g7 oil_div_gdp if location == "`loc'", lags(1/4)
irf create order1, step(20) set(C:\Users\Philip\Desktop\New\symmetric_`loc',replace)
irf table cirf, impulse(d_l_oil_price_opec_real) response(d_gdp) step(11) level(90)
}

***NOPI
foreach loc in `countries'{
qui var d_gdp nopi d_l_cpi d_interest d_unemployment d_l_ipi_g7 oil_div_gdp if location == "`loc'", lags(1/4)
irf create order1, step(20) set(C:\Users\Philip\Desktop\New\nopi_`loc',replace)
irf table cirf oirf, impulse(nopi) response(d_gdp) step(11) level(90)
}
...
irf create order1, step(20) set(C:\Users\Philip\Desktop\New\pos_`loc',replace)
irf table cirf oirf, impulse(pos_d_l_oil_price_opec_real) response(d_gdp) step(11) level(90)
}
...
irf create order1, step(20) set(C:\Users\Philip\Desktop\New\neg_`loc',replace)
irf table cirf oirf, impulse(neg_d_l_oil_price_opec_real) response(d_gdp) step(11) level(90)
}

*SOPI
foreach loc in `countries'{
qui var d_gdp sopi d_l_cpi d_interest d_unemployment d_l_ipi_g7 oil_div_gdp if location == "`loc'", lags(1/4)
irf create order1, step(20) set(C:\Users\Philip\Desktop\New\sopi_`loc',replace)
irf table cirf oirf, impulse(sopi) response(d_gdp) step(11) level(90)
}
*/
*SOPD
foreach loc in `countries'{
qui var d_gdp sopd d_l_cpi d_interest d_unemployment d_l_ipi_g7 oil_div_gdp if location == "`loc'", lags(1/4)
irf create order1, step(20) set(C:\Users\Philip\Desktop\New\sopd_`loc',replace)
irf table cirf oirf, impulse(sopd) response(d_gdp) step(11) level(90)
}
