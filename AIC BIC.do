...
*Symmetric
foreach loc in `countries'{
eststo: qui var d_gdp d_l_cpi d_interest d_unemployment d_l_ipi_g7 oil_div_gdp d_l_oil_price_opec_real if location == "`loc'", lags(1/4)
*esttab using "C:\Users\Philip\sciebo\Research\own_paper\paper\Output\Tables_2\Var\symmetric_`loc'.csv", replace star(* 0.1 ** 0.05 *** 0.01)
varsoc
eststo clear
}
/*
*NOPI
foreach loc in `countries'{
eststo: qui var d_gdp d_l_cpi d_interest d_unemployment d_l_ipi_g7 oil_div_gdp nopi if location == "`loc'", lags(1/4)
*esttab using "C:\Users\Philip\sciebo\Research\own_paper\paper\Output\Tables_2\Var\nopi_`loc'.csv", replace star(* 0.1 ** 0.05 *** 0.01)
varsoc
eststo clear
}
...
*AsymPositive
foreach loc in `countries'{
eststo: qui var d_gdp d_l_cpi d_interest d_unemployment d_l_ipi_g7 oil_div_gdp pos_d_l_oil_price_opec_real if location == "`loc'", lags(1/4)
*esttab using "C:\Users\Philip\sciebo\Research\own_paper\paper\Output\Tables_2\Var\asymmetric_pos_`loc'.csv", replace star(* 0.1 ** 0.05 *** 0.01)
varsoc
eststo clear
}
*AsymNegative
foreach loc in `countries'{
eststo: qui var d_gdp d_l_cpi d_interest d_unemployment d_l_ipi_g7 oil_div_gdp neg_d_l_oil_price_opec_real if location == "`loc'", lags(1/4)
*esttab using "C:\Users\Philip\sciebo\Research\own_paper\paper\Output\Tables_2\Var\asymmetric_pos_`loc'.csv", replace star(* 0.1 ** 0.05 *** 0.01)
varsoc
eststo clear
}
...
*SOPI
foreach loc in `countries'{
eststo: qui var d_gdp d_l_cpi d_interest d_unemployment d_l_ipi_g7 oil_div_gdp sopi if location == "`loc'", lags(1/4)
*esttab using "C:\Users\Philip\sciebo\Research\own_paper\paper\Output\Tables_2\Var\sopi_`loc'.csv", replace star(* 0.1 ** 0.05 *** 0.01)
varsoc
eststo clear
}
*SOPD
foreach loc in `countries'{
eststo: qui var d_gdp d_l_cpi d_interest d_unemployment d_l_ipi_g7 oil_div_gdp sopd if location == "`loc'", lags(1/4)
*esttab using "C:\Users\Philip\sciebo\Research\own_paper\paper\Output\Tables_2\Var\sopi_`loc'.csv", replace star(* 0.1 ** 0.05 *** 0.01)
varsoc
eststo clear
}
