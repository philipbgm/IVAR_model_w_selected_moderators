...
*Three periods IRFs
*OIRF only
*w/o Moderator and right order


*Symmetric
foreach loc in `countries'{
var d_gdp d_l_oil_price_opec_real d_l_cpi d_interest d_unemployment d_l_ipi_g7 oil_div_gdp if location == "`loc'", lags(1/4)
	test (l.d_l_oil_price_opec_real==0) (l2.d_l_oil_price_opec_real==0) (l3.d_l_oil_price_opec_real==0) (l4.d_l_oil_price_opec_real==0)
*irf create order1, step(20) set(C:\Users\pbergmann\sciebo\Research\own_paper\paper\Output\Tables_2\Var\oirf\comb_3_periods\symmetric_`loc',replace)
*irf table oirf, impulse(d_l_oil_price_opec_real) response(d_gdp) step(20)
*irf graph oirf, impulse(d_l_oil_price_opec_real) response(d_gdp)
*graph export C:\Users\Philip\sciebo\Research\own_paper\paper\Output\Tables_2\Var\oirf\comb_3_periods\symmetric_`loc'.pdf, as(pdf) replace
}
...
*Asymmetric Pos
foreach loc in `countries'{
qui var d_gdp pos_d_l_oil_price_opec_real d_l_cpi d_interest d_unemployment d_l_ipi_g7 oil_div_gdp if location == "`loc'", lags(1/4)
	test (l.pos_d_l_oil_price_opec_real==0) (l2.pos_d_l_oil_price_opec_real==0) (l3.pos_d_l_oil_price_opec_real==0) (l4.pos_d_l_oil_price_opec_real==0)
*irf create order1, step(20) set(C:\Users\pbergmann\sciebo\Research\own_paper\paper\Output\Tables_2\Var\oirf\comb_3_periods\base_asymmetric_pos_`loc',replace)
*irf table oirf, impulse(pos_d_l_oil_price_opec_real) response(d_gdp) step(20)
*irf graph oirf, impulse(pos_d_l_oil_price_opec_real) response(d_gdp)
*graph export C:\Users\Philip\sciebo\Research\own_paper\paper\Output\Tables_2\Var\oirf\comb_3_periods\symmetric_`loc'.pdf, as(pdf) replace
}
...
*Asymmetric Neg
foreach loc in `countries'{
qui var d_gdp neg_d_l_oil_price_opec_real d_l_cpi d_interest d_unemployment d_l_ipi_g7 oil_div_gdp if location == "`loc'", lags(1/4)
	test (l.neg_d_l_oil_price_opec_real==0) (l2.neg_d_l_oil_price_opec_real==0) (l3.neg_d_l_oil_price_opec_real==0) (l4.neg_d_l_oil_price_opec_real==0)
*irf create order1, step(20) set(C:\Users\pbergmann\sciebo\Research\own_paper\paper\Output\Tables_2\Var\oirf\comb_3_periods\base_asymmetric_neg_`loc',replace)
*irf table oirf, impulse(neg_d_l_oil_price_opec_real) response(d_gdp) step(20)
*irf graph oirf, impulse(neg_d_l_oil_price_opec_real) response(d_gdp)
*graph export C:\Users\Philip\sciebo\Research\own_paper\paper\Output\Tables_2\Var\oirf\comb_3_periods\symmetric_`loc'.pdf, as(pdf) replace
}
...
*SOPI
foreach loc in `countries'{
qui var d_gdp sopi d_l_cpi d_interest d_unemployment d_l_ipi_g7 oil_div_gdp if location == "`loc'", lags(1/4)
	test (l.sopi==0) (l2.sopi==0) (l3.sopi==0) (l4.sopi==0)
*irf create order1, step(20) set(C:\Users\pbergmann\sciebo\Research\own_paper\paper\Output\Tables_2\Var\oirf\comb_3_periods\base_sopi_`loc',replace)
*irf table oirf, impulse(sopi) response(d_gdp) step(20)
*irf graph oirf, impulse(sopi) response(d_gdp)
*graph export C:\Users\Philip\sciebo\Research\own_paper\paper\Output\Tables_2\Var\oirf\comb_3_periods\symmetric_`loc'.pdf, as(pdf) replace
}
...
*SOPD
foreach loc in `countries'{
qui var d_gdp sopd d_l_cpi d_interest d_unemployment d_l_ipi_g7 oil_div_gdp if location == "`loc'", lags(1/4)
	test (l.sopd==0) (l2.sopd==0) (l3.sopd==0) (l4.sopd==0)
*irf create order1, step(20) set(C:\Users\pbergmann\sciebo\Research\own_paper\paper\Output\Tables_2\Var\oirf\comb_3_periods\base_sopd_`loc',replace)
*irf table oirf, impulse(sopd) response(d_gdp) step(20)
*irf graph oirf, impulse(sopd) response(d_gdp)
*graph export C:\Users\Philip\sciebo\Research\own_paper\paper\Output\Tables_2\Var\oirf\comb_3_periods\symmetric_`loc'.pdf, as(pdf) replace
}
...
*NOPI
foreach loc in `countries'{
qui var d_gdp nopi d_l_cpi d_interest d_unemployment d_l_ipi_g7 oil_div_gdp if location == "`loc'", lags(1/4)
	test (l.nopi==0) (l2.nopi==0) (l3.nopi==0) (l4.nopi==0)
*irf create order1, step(20) set(C:\Users\pbergmann\sciebo\Research\own_paper\paper\Output\Tables_2\Var\oirf\comb_3_periods\base_nopi_`loc',replace)
*irf table oirf, impulse(nopi) response(d_gdp) step(20)
*irf graph oirf, impulse(nopi) response(d_gdp)
*graph export C:\Users\Philip\sciebo\Research\own_paper\paper\Output\Tables_2\Var\oirf\comb_3_periods\symmetric_`loc'.pdf, as(pdf) replace
}
