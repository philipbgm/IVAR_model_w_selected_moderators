...
dfuller gdp_v if location=="`loc'", trend
scalar tmt_gdp_`loc' = r(Zt)
dfuller gdp_v if location=="`loc'"
scalar mt_gdp_`loc' = r(Zt)
dfuller gdp_v if location=="`loc'", noconstant
scalar nmt_gdp_`loc' = r(Zt)

dfuller gdp if location=="`loc'", trend
scalar tmt_dgdp_`loc' = r(Zt)
dfuller gdp if location=="`loc'"
scalar mt_dgdp_`loc' = r(Zt)
dfuller gdp if location=="`loc'", noconstant
scalar nmt_dgdp_`loc' = r(Zt)

dfuller cpi if location=="`loc'", trend
scalar tmt_cpi_`loc' = r(Zt)
dfuller cpi if location=="`loc'"
scalar mt_cpi_`loc' = r(Zt)
dfuller cpi if location=="`loc'", noconstant
scalar nmt_cpi_`loc' = r(Zt)

dfuller d_l_cpi if location=="`loc'", trend
scalar tmt_dcpi_`loc' = r(Zt)
dfuller d_l_cpi if location=="`loc'"
scalar mt_dcpi_`loc' = r(Zt)
dfuller d_l_cpi if location=="`loc'", noconstant
scalar nmt_dcpi_`loc' = r(Zt)

dfuller interest if location=="`loc'", trend
scalar tmt_interest_`loc' = r(Zt)
dfuller interest if location=="`loc'"
scalar mt_interest_`loc' = r(Zt)
dfuller interest if location=="`loc'", noconstant
scalar nmt_interest_`loc' = r(Zt)

dfuller d_interest if location=="`loc'", trend
scalar tmt_dinterest_`loc' = r(Zt)
dfuller d_interest if location=="`loc'"
scalar mt_dinterest_`loc' = r(Zt)
dfuller d_interest if location=="`loc'", noconstant
scalar nmt_dinterest_`loc' = r(Zt)

dfuller unemployment if location=="`loc'", trend
scalar tmt_unemployment_`loc' = r(Zt)
dfuller unemployment if location=="`loc'"
scalar mt_unemployment_`loc' = r(Zt)
dfuller unemployment if location=="`loc'", noconstant
scalar nmt_unemployment_`loc' = r(Zt)

dfuller d_unemployment if location=="`loc'", trend
scalar tmt_dunemployment_`loc' = r(Zt)
dfuller d_unemployment if location=="`loc'"
scalar mt_dunemployment_`loc' = r(Zt)
dfuller d_unemployment if location=="`loc'", noconstant
scalar nmt_dunemployment_`loc' = r(Zt)

dfuller ipi_g7 if location=="`loc'", trend
scalar tmt_ipig7_`loc' = r(Zt)
dfuller ipi_g7 if location=="`loc'"
scalar mt_ipig7_`loc' = r(Zt)
dfuller ipi_g7 if location=="`loc'", noconstant
scalar nmt_ipig7_`loc' = r(Zt)

dfuller d_l_ipi_g7 if location=="`loc'", trend
scalar tmt_dipig7_`loc' = r(Zt)
dfuller d_l_ipi_g7 if location=="`loc'"
scalar mt_dipig7_`loc' = r(Zt)
dfuller d_l_ipi_g7 if location=="`loc'", noconstant
scalar nmt_dipig7_`loc' = r(Zt)

dfuller oil_div_gdp if location=="`loc'", trend
scalar tmt_oildivgdp_`loc' = r(Zt)
dfuller oil_div_gdp if location=="`loc'"
scalar mt_oildivgdp_`loc' = r(Zt)
dfuller oil_div_gdp if location=="`loc'", noconstant
scalar nmt_oildivgdp_`loc' = r(Zt)

dfuller d_l_oil_div_gdp if location=="`loc'", trend
scalar tmt_doildivgdp_`loc' = r(Zt)
dfuller d_l_oil_div_gdp if location=="`loc'"
scalar mt_doildivgdp_`loc' = r(Zt)
dfuller d_l_oil_div_gdp if location=="`loc'", noconstant
scalar nmt_doildivgdp_`loc' = r(Zt)

dfuller oil_price_loc if location=="`loc'", trend
scalar tmt_oil_`loc' = r(Zt)
dfuller oil_price_loc if location=="`loc'"
scalar mt_oil_`loc' = r(Zt)
dfuller oil_price_loc if location=="`loc'", noconstant
scalar nmt_oil_`loc' = r(Zt)

dfuller d_l_oil_price_loc if location=="`loc'", trend
scalar tmt_doil_`loc' = r(Zt)
dfuller d_l_oil_price_loc if location=="`loc'"
scalar mt_doil_`loc' = r(Zt)
dfuller d_l_oil_price_loc if location=="`loc'", noconstant
scalar nmt_doil_`loc' = r(Zt)

dfuller energy_share_est if location=="`loc'", trend
scalar tmt_energy_share_est_`loc' = r(Zt)
dfuller energy_share_est if location=="`loc'"
scalar mt_energy_share_est_`loc' = r(Zt)
dfuller energy_share_est if location=="`loc'", noconstant
scalar nmt_energy_share_est_`loc' = r(Zt)

dfuller d_l_energy_share_est if location=="`loc'", trend
scalar tmt_denergy_share_est_`loc' = r(Zt)
dfuller d_l_energy_share_est if location=="`loc'"
scalar mt_denergy_share_est_`loc' = r(Zt)
dfuller d_l_energy_share_est if location=="`loc'", noconstant
scalar nmt_denergy_share_est_`loc' = r(Zt)
